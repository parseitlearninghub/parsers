...
async function renderAssignmentUI() {
    ...
    const assignmentRef = ref(
        database,
        `PARSEIT/administration/parseclass/${acadref}/${yearlvl}/${sem}/${subject}/${section}/materials/${assignmentcode}`
    );
    await onValue(assignmentRef, async (snapshot) => {
        ...
        if (snapshot.exists()) {
            ...
            const usernameRef = child(dbRef, `PARSEIT/administration/parseclass/${acadref}/${yearlvl}/${sem}/${subject}/${section}/materials/${assignmentcode}/attachedfile/`);
        ...
        postedDateLabel.textContent = `Uploaded ${formatDateTime(assignment_date)}`;
        ...
        submitButton.textContent = 'Delete Material';
        submitButton.addEventListener('click', async () => {
            await remove(ref(database, `PARSEIT/administration/parseclass/${acadref}/${yearlvl}/${sem}/${subject}/${section}/materials/${assignmentcode}/`));
            window.location.href = 'parseroom.html';
        });
        if (type === "teacher") {
