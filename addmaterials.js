...
document.getElementById("createassignment-btn").addEventListener("click", async () => {
    ...
    await update(ref(database, `PARSEIT/administration/parseclass/${acadref}/${yearlvl}/${sem}/${subject}/${section}/materials/${assignmentcode}/`), {
        header: header,
...
async function uploadFileToGitHub(token, owner, repo, filePath, fileContent, filename) {
    ...
    try {
        ...
        removeSection.addEventListener('click', async (event) => {
            ...
            await remove(ref(database, `PARSEIT/administration/parseclass/${acadref}/${yearlvl}/${sem}/${subject}/${section}/materials/${assignmentcode}/attachedfile/${attachmentcode}/`));
        ...
        await update(ref(database, `PARSEIT/administration/parseclass/${acadref}/${yearlvl}/${sem}/${subject}/${section}/materials/${assignmentcode}/attachedfile/${attachmentcode}/`), {
